...
class CadastroClienteControllerTest {
    ...
    void cadastraCliente_DeveRetornarCreatedComLocation(){
        ...
        ResponseEntity<Void> response = cadastroClienteController.cadastroCliente(request, uriBuilder);
    ...
    void listaTodosOsClientes_DeveRetornarListaDeClientes() throws ParseException {
        ...
        ResponseEntity<List<CadastroClienteResponse>> response = cadastroClienteController.listaTodosOsCliente();
